...
Note that for the second option (i.e., the release npm script), you'll need to make sure that a GITHUB_TOKEN environment variable is available, as explained here: https://github.com/release-it/release-it/blob/master/docs/environment-variables.md
